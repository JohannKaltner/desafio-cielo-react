export type LancamentoContaClienteT = {
...
export type LancamentoContaClienteContextState = {
  LancamentoContaCliente: LancamentoContaClienteT[];
  setLancamento: (ContaCliente: any) => void;
};
